import { StyleSheet, Text, View, SafeAreaView, Image, KeyboardAvoidingView, TextInput, Pressable, TouchableOpacity, Button } from 'react-native';
...
const LoginPage = ({ navigation }) => {
   ...
   const handleLogin = async () => {
       // 在此处发送请求到后端
       try {
           let response = await fetch('http://localhost:8080/prod-api/api/prouser/login', {
               method: 'POST',
               headers: {
